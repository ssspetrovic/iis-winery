...
SECRET_KEY = 'django-insecure-5$yks9glt7859w725vc^4zwjf&^on!)wlpl_k)u-l%9ct20cyw'
...
ASGI_APPLICATION = 'winery.asgi.application'
...
# # Media configuration for the images
# MEDIA_URL = '/media/'
...
# The data directory path, can be later joined with other files inside that data
